...
export const metadata: Metadata = {
  title: "Bella Vista | Authentic Italian Fine Dining Restaurant",
  description: "Experience authentic Italian cuisine at Bella Vista. Traditional flavors, elegant atmosphere, and exceptional service in the heart of the city. Reserve your table today.",
  keywords: "Italian restaurant, fine dining, authentic cuisine, pasta, seafood, wine, reservations, elegant dining",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Bella Vista | Authentic Italian Fine Dining Restaurant",
    description: "Experience authentic Italian cuisine with traditional flavors and elegant atmosphere. Reserve your table today.",
  ...
  twitter: {
    ...
    title: "Bella Vista | Authentic Italian Fine Dining Restaurant",
    description: "Experience authentic Italian cuisine with traditional flavors and elegant atmosphere.",
